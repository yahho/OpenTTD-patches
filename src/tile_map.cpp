...
bool IsTileFlat(TileIndex tile, int *h)
{
	...
	uint a = TileHeight(tile);
	if (TileHeight(tile + TileDiffXY(1, 0)) != a) return false;
	if (TileHeight(tile + TileDiffXY(0, 1)) != a) return false;
	if (TileHeight(tile + TileDiffXY(1, 1)) != a) return false;
