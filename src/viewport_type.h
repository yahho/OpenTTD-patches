...
enum ViewportPlaceMethod {
	...
	VPM_X_AND_Y_ROTATED =    4, ///< area of land, allow rotation
	VPM_X_AND_Y_LIMITED =    5, ///< area of land of limited size
	VPM_FIX_HORIZONTAL  =    6, ///< drag only in horizontal direction
	VPM_FIX_VERTICAL    =    7, ///< drag only in vertical direction
	VPM_X_LIMITED       =    8, ///< Drag only in X axis with limited size
	VPM_Y_LIMITED       =    9, ///< Drag only in Y axis with limited size
