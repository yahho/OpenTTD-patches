...
/* static */ bool ScriptTile::IsBuildable(TileIndex tile)
{
	...
	switch (::GetTileType(tile)) {
		...
		case TT_GROUND: return IsGroundTile(tile);
...
/* static */ bool ScriptTile::IsCoastTile(TileIndex tile)
{
	...
	return (::IsWaterTile(tile) && ::IsCoast(tile)) ||
		(::IsTreeTile(tile) && ::GetClearGround(tile) == GROUND_SHORE);
}
...
/* static */ bool ScriptTile::IsRockTile(TileIndex tile)
{
	...
	return (::IsClearTile(tile) && ::GetRawClearGround(tile) == ::GROUND_ROCKS);
}
...
/* static */ bool ScriptTile::IsRoughTile(TileIndex tile)
{
	...
	return (::IsClearTile(tile) && ::GetRawClearGround(tile) == ::GROUND_ROUGH);
}
...
/* static */ bool ScriptTile::IsDesertTile(TileIndex tile)
{
	...
	return (::IsClearTile(tile) && ::IsClearGround(tile, GROUND_DESERT));
}
...
/* static */ int32 ScriptTile::GetCargoAcceptance(TileIndex tile, CargoID cargo_type, int width, int height, int radius)
{
	...
	CargoArray acceptance = GetAreaAcceptance (TileArea (tile, width, height),
