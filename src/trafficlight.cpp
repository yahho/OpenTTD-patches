 ...
 */
CommandCost CmdBuildTrafficLights(TileIndex tile, DoCommandFlag flags, uint64 p1, uint64 p2, const char *text)
{
 ...
 * @return CommandCost Cost or error.
 */
CommandCost CmdRemoveTrafficLights(TileIndex tile, DoCommandFlag flags, uint64 p1, uint64 p2, const char *text)
{
