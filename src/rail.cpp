...
extern const DiagDirection _trackdir_to_exitdir[TRACKDIR_END] = {
	DIAGDIR_NE, DIAGDIR_SE, DIAGDIR_NE, DIAGDIR_SE, DIAGDIR_SW, DIAGDIR_SE, DIAGDIR_SW, DIAGDIR_NW,
	DIAGDIR_SW, DIAGDIR_NW, DIAGDIR_NW, DIAGDIR_SW, DIAGDIR_NW, DIAGDIR_NE, DIAGDIR_NE, DIAGDIR_SE,
};
...
extern const Trackdir _enterdir_exitdir_to_trackdir[DIAGDIR_END][DIAGDIR_END] = {
	{TRACKDIR_X_NE,     TRACKDIR_LOWER_E,  TRACKDIR_RVREV_NE, TRACKDIR_LEFT_N  },
	{TRACKDIR_UPPER_E,  TRACKDIR_Y_SE,     TRACKDIR_LEFT_S,   TRACKDIR_RVREV_SE},
	{TRACKDIR_RVREV_SW, TRACKDIR_RIGHT_S,  TRACKDIR_X_SW,     TRACKDIR_UPPER_W },
	{TRACKDIR_RIGHT_N,  TRACKDIR_RVREV_NW, TRACKDIR_LOWER_W,  TRACKDIR_Y_NW    },
};
