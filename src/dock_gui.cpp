...
void CcBuildDocks(const CommandCost &result, TileIndex tile, uint64 p1, uint64 p2)
{
...
void CcBuildCanal(const CommandCost &result, TileIndex tile, uint64 p1, uint64 p2)
{
...
struct BuildDocksToolbarWindow : Window {
	...
	virtual void OnClick(Point pt, int widget, int click_count)
	{
		switch (widget) {
			...
			case WID_DT_RIVER: // Build river button
