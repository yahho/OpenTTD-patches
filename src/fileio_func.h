...
int FioGetFullPath (char *buf, size_t buflen, Searchpath sp, Subdirectory subdir, const char *filename = NULL);
...
public:
	...
	uint Scan(const char *extension, const char *directory, const char *dirend, bool recursive);
